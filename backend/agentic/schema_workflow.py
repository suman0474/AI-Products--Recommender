...
class SchemaWorkflow:
    ...
    async def _generate_schema_phase3_async(self, product_type: str) -> Dict[str, Any]:
        ...
        try:
            from agentic.deep_agent.async_schema_generator import generate_schemas_async
    ...
    async def _generate_schema_phase2_parallel(self, product_type: str) -> Dict[str, Any]:
        ...
        try:
            from agentic.deep_agent.parallel_schema_generator import generate_schemas_parallel
    ...
    async def _enrich_schema(
        ...
        try:
            if self.use_phase3_async:
                from agentic.standards_rag.async_standards_enrichment import enrich_schema_async

                enriched = await enrich_schema_async(product_type, schema)
            else:
                from agentic.standards_rag.parallel_standards_enrichment import enrich_schema_parallel
