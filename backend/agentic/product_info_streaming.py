"""
Product Info Streaming Module

Provides streaming wrapper for Product Info queries with progress updates
...
# ============================================================================
# PRODUCT INFO WORKFLOW STREAMING
# ============================================================================
...
def run_product_info_query_stream(
    query: str,
    ...
    """
    Run Product Info query with streaming progress updates.

    This is the streaming version of run_product_info_query that emits
    progress events for:
...
def run_product_info_query_stream_detailed(
    query: str,
    session_id: str = "default",
    rag_type: str = None,
    validate: bool = True,
    ...
    """
    Run Product Info query with detailed manual progress control.
    ...
    try:
        ...
        logger.error(f"[PRODUCT_INFO_STREAM] Error: {e}", exc_info=True)
